...
// Este LED, llamado RGB, tiene en su interior 3 LEDs diferentes: Rojo, Verde y Azul, que al combinarlos en
// distintas proporciones, muestran un nuevo color.
//
// Tu robot cuenta con 8 color predefinidos, los cuales pueden ser:
//
// BLACK
// RED
// GREEN
